  ...
  function render() {
    ...
    foreach($this->blocks as $i => $block) {
      ...
      foreach($this->days as $day) {
        ...
        $html[] = '<li class="gantt-day' . $weekend . $today . '" ' . $wrapstyle . '><span ' . $cellstyle . '>' . $day . ' Days</span></li>';
      }                      
      $html[] = '</ul>';    
      ...
      $html[] = '<span class="gantt-block' . $class . '" style="left: ' . $left . 'px; width: ' . $width . 'px; height: ' . $height . 'px"><strong class="gantt-block-label">' . $days . ' Days</strong></span>';
      $html[] = '</li>';
